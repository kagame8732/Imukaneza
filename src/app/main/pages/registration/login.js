...
const Login = (props) => {
    ...
    return ( <
        ...
        <
        button className = "btn btn btn_color_dark"
        id = "login_button" > Sign in < /button> <
        ul id = "list_style_none"
        onClick = {
            () => { history.push('/signup') } } >
        <
        li > Not a member ? < /li> <
        li className = "color_primary"
        id = "active_login" > Sign up now < /li> <
        /ul> <
        p className = "color_primary"
        id = "active_forgrt" > Forgot Password ? < /p> <
