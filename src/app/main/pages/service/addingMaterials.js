...
const ServiceAdd = (props) => {
    ...
    return ( <
        div > { /* this Phone version */ }

        <
        div className = "row col-12 noM" >
        <
        div className = "col-sm-2 noM"
        id = "left_side_admin" > { /* this Left side version for pc*/ } <
        LeftSideMenu whichOne = "Service"
        isPhone = { false }
        /> <
        /div> <
        div className = "col-sm margin-0"
        id = "middle_side_admin" > { /* this Middle side version for all */ } <
        ...
        <
        option value = { props.location.state.ServiceType }
        selected disabled hidden > { props.location.state.ServiceType } < /option> <
        ...
        /select> {
            typeService === "Ride" ?
                ...
                <
                option value = ""
            selected disabled hidden > Choose Your Category < /option> <
                ...
                <
                input type = "text"
            id = "selcter_adding_service"
            placeholder = "eg:KG 383 St, Kigali" / >
                <
                ...
                <
                option value = ""
            selected disabled hidden > Select Your Driver < /option> <
        ...
        id = "right_side_admin" > { /* this Right side version for pc*/ } <
        RightSideMenu / >
        <
        /div> <
        /div> <
