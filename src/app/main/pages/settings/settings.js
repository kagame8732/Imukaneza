...
const SettingsPage = () => {
    ...
    return ( <
        ...
        <
        div className = "col-sm-2 margin-0"
        id = "left_side_admin" > { /* this Left side version for pc*/ } <
        LeftSideMenu whichOne = "Settings"
        isPhone = { false }
        /> < /
        div > <
        ...
        id = "name_on_setting" > imuka neza < /p>  <
        p className = "margin-0"
        id = "name_on_location" > Kigali, Niboye < /p>    < /
        div > <
        /div> < /
        div > <
        div className = "row col-12 margin-0"
        id = "margin_top_botton_setting" >
        <
        div className = "col-sm" >
        <
        label id = "setting_inputs_name" > Name < /label><br/ >
        <
        input defaultValue = "imuka neza"
        id = "setting_inputs" / >
        <
        /div> <
        div className = "col-sm" >
        ...
        <
        input defaultValue = "info@imukaneza.rw"
        id = "setting_inputs" / >
        <
        /div> < /
        div > <
        ...
        <
        input defaultValue = "+250 788549923"
        id = "setting_inputs" / >
        <
        /div> <
        div className = "col-sm" >
        ...
        <
        input defaultValue = "Kigali,Niboye"
        id = "setting_inputs" / >
        <
        /div> < /
        div > <
        ...
        /div> < /
        div > <
        div className = "col-sm-3 margin-0"
